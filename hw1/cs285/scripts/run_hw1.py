...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          random_indices = np.random.permutation(len(replay_buffer.obs))[:batch_size]
          
          # Get corresponding observations and actions
          ob_batch = replay_buffer.obs[random_indices]
          ac_batch = replay_buffer.acs[random_indices]
