...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          shuffled_replay_buffer = np.random.permutation(len(replay_buffer))[0:params['train_batch_size']]


          ob_batch, ac_batch = replay_buffer.obs[shuffled_replay_buffer], replay_buffer.acs[shuffled_replay_buffer]
